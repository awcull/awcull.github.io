...
This makes sense as the host nations Brazil (2016) and London (2012) to have the biggest changes.  Russia is special in this case as bans for doping has removed a large number of them.
...
![]({{ site.url }}//Volumes/Lexar/assets/2016-vs-2012-Athlete-Num/unnamed-chunk-2-1.png)![]({{ site.url }}//Volumes/Lexar/assets/2016-vs-2012-Athlete-Num/unnamed-chunk-2-2.png)
